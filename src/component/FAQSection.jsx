      ...
      <FadeIn direction="up" duration={800}>
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tighter uppercase relative z-10">
            Frequently <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E68A00] to-[#F69415]">Asked</span> Questions
          </h2>
          ...
          <FadeIn key={index} direction="up" delay={index * 100} duration={600}>
            <div
              className={`
                ...
                ${openIndex === index
                  ? 'bg-[#E68A00]/15 border-[#E68A00]/50 shadow-[0_0_30px_rgba(230,138,0,0.1)]'
                  : 'bg-[#E68A00]/10 border-white/10 hover:bg-[#E68A00]/15 hover:border-[#E68A00]/30'
                }
              `}
            >
              <button
              ...
              >
                <span className={`text-lg md:text-xl font-semibold transition-colors duration-300 ${openIndex === index ? 'text-[#E68A00]' : 'text-white group-hover:text-[#E68A00]'}`}>
                  {faq.question}
                </span>
                <div className={`
                   w-8 h-8 rounded-full flex items-center justify-center border transition-all duration-300
                   ${openIndex === index ? 'border-[#E68A00] bg-[#E68A00] text-black rotate-180' : 'border-white/20 text-white group-hover:border-[#E68A00]'}
                `}>
              ...
              >
                <div className="px-8 pb-6 text-gray-300 text-base md:text-lg leading-relaxed border-t border-[#E68A00]/30 pt-4 mt-2">
                  {faq.answer}
                </div>
              </div>
            </div>

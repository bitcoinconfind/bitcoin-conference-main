      ...
      <div className="premium-card p-4 md:p-6 flex flex-col h-full relative">
        ...
        {isPopular && (
          <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
            <span className="bg-[#E68A00] text-black px-4 py-1 rounded-full text-sm font-semibold">
              Most Valuable
            </span>
          </div>
        )}
        ...
        <div className="text-center mb-4">
          ...
          <div className="text-3xl md:text-4xl font-bold text-[#E68A00] mb-2">
            ${tier.price}
        ...
        <div className="w-full">
          <Button
            label="Coming Soon"
            variant="secondary"
            className="w-full py-2 md:py-3 text-sm md:text-lg font-semibold cursor-not-allowed mt-auto !border-[#E68A00] !border-2 !bg-[#E68A00] !text-black opacity-100 shadow-[0_0_10px_rgba(230,138,0,0.3)] hover:!bg-[#E68A00] hover:!shadow-[0_0_20px_rgba(230,138,0,0.6)] transition-all duration-300"
            disabled={true}
          />
        </div>
      </div>

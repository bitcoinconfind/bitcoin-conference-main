          ...
          <div className="grid grid-cols-2 gap-4 lg:gap-6 w-full max-w-lg">
            <FadeIn direction="up" delay={200} duration={800}>
              <div ref={statesRef} className="relative group overflow-hidden rounded-3xl border border-white/10 bg-[#FF8000]/10 p-6 transition-all hover:border-[#FF8000]/30 hover:bg-[#FF8000]/15 h-full flex flex-col justify-center min-h-[160px]">
                ...
                {/* Decorative Blob */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#FF8000]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
            </FadeIn>
            ...
            <FadeIn direction="up" delay={500} duration={800}>
              <div ref={educationRef} className="relative group overflow-hidden rounded-3xl border border-[#FF8000] bg-[#FF8000] p-6 transition-all hover:bg-[#FF8000]/90 h-full flex flex-col justify-center min-h-[160px] shadow-[0_0_30px_rgba(255,128,0,0.3)]">
                <div className="relative z-10">
                  <div className="text-2xl md:text-3xl font-black text-black mb-2 font-heading leading-tight">{educationText}</div>
                  <span className="text-3xl font-black text-[#FF8000]/30 group-hover:text-[#FF8000] transition-colors duration-300 mr-4"></span>
        ...
        <div className="w-full lg:w-[55%] relative z-20">
          <FadeIn direction="left" delay={200} duration={1000} className="relative z-20">
            <div className="relative aspect-square w-full pointer-events-auto">
              <IndiaMapSvg
                className="w-full h-full object-contain drop-shadow-[0_0_50px_rgba(255,128,0,0.15)] scale-105 lg:scale-110 origin-center translate-x-12 lg:translate-x-24 relative z-20"
              />
              {/* Dynamic Back Glow */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 h-4/5 bg-gradient-to-tr from-[#FF8000]/10 to-transparent rounded-full blur-[80px] -z-10"></div>
            </div>
          </FadeIn>
        </div>

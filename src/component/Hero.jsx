...
const Hero = () => {
    ...
    return (
        ...
        <section className="relative w-full min-h-[65vh] lg:min-h-[85vh] flex flex-col justify-start px-4 sm:px-8 lg:px-24 overflow-hidden pt-20 lg:pt-24 pb-12 lg:pb-24">

    ...
    <div id="tickets" className="max-w-7xl mx-auto px-4 md:px-8">
      ...
      <FadeIn direction="up" duration={800}>
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tighter uppercase relative z-10">
            Grab Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E68A00] to-[#FFC04D]">Tickets</span>
          </h2>
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:h-[600px]">
        ...
        <div className="lg:w-2/3 h-full">
          <div className="relative h-full bg-black/60 backdrop-blur-xl border border-[#E68A00]/30 rounded-3xl p-8 lg:p-12 overflow-hidden flex flex-col lg:flex-row gap-8 transition-all duration-500 shadow-2xl">

            {/* Background Glow */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#E68A00]/10 blur-[100px] rounded-full pointer-events-none"></div>
            ...
            <div className="lg:w-[50%] flex flex-col items-center justify-center">
              <img
                ...
                className="w-full h-auto max-h-[550px] object-contain drop-shadow-[0_0_30px_rgba(230,138,0,0.3)] transform transition-transform duration-500 key={activeTierIndex} animate-in fade-in zoom-in-95"
              />
              <div className="mt-6 text-center">
                <div className="text-4xl font-bold text-[#E68A00] mb-1"><span className="text-[#E68A00]">$</span>{activeTier.price}</div>
            ...
            <div className="lg:w-[50%] flex flex-col relative z-10 h-full">
              <h3 className="text-3xl lg:text-5xl font-bold text-[#E68A00] mb-6 font-heading tracking-tight">{activeTier.title}</h3>
              ...
              <div className="flex-grow overflow-y-auto pr-2 custom-scrollbar space-y-4 mb-8 pointer-events-auto">
                {activeTier.features.map((feature, idx) => (
                  <div key={idx} className="flex items-start gap-3 group">
                    <div className="mt-2.5 w-1.5 h-1.5 rounded-full bg-[#E68A00] group-hover:shadow-[0_0_8px_#E68A00] transition-all flex-shrink-0"></div>
              ...
              <Button
                ...
                variant="primary"
                disabled={true}
                className="w-full lg:w-auto self-start mt-auto !bg-[#E68A00] !text-black font-bold text-lg px-8 py-4 opacity-70 cursor-not-allowed"
              />
            </div>
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={`relative p-6 rounded-2xl text-left transition-all duration-300 group border backdrop-blur-sm
                   ${isActive
                    ? 'bg-black/70 border-[#E68A00] shadow-[0_0_30px_rgba(230,138,0,0.15)] scale-105 z-10'
                    : 'bg-black/40 border-[#E68A00]/30 hover:bg-black/60 hover:border-[#E68A00]/50 opacity-70 hover:opacity-100'
                  }
                 `}
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className={`text-xl font-bold mb-1 transition-colors text-[#E68A00]`}>
                      {tier.title}
                    </div>
        ...
        <div className="mt-20 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-white max-w-4xl mx-auto">
            <div className="text-center card-hover-lift">
              <div className="text-[#E68A00] font-sora font-bold text-3xl mb-2">Hyderabad</div>
              <div className="metric-label text-sm">Location</div>
            </div>
            <div className="text-center card-hover-lift">
              <div className="text-[#E68A00] font-sora font-bold text-3xl mb-2">2026</div>
              <div className="metric-label text-sm">Year</div>
            </div>
            <div className="text-center card-hover-lift">
              <div className="text-[#E68A00] font-sora font-bold text-3xl mb-2">MARCH</div>

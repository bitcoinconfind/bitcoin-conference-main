      ...
      <FadeIn direction="up" duration={800}>
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tighter uppercase relative z-10">
            Grab Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6501] to-[#FFC04D]">Tickets</span>
          </h2>
          ...
          <div className="relative h-full bg-black/60 backdrop-blur-xl border border-[#FF6501]/30 rounded-3xl p-8 lg:p-12 overflow-hidden flex flex-col lg:flex-row gap-8 transition-all duration-500 shadow-2xl">
            ...
            <div className="lg:w-[50%] flex flex-col relative z-10 h-full">
              ...
              <Button
                ...
                variant="primary"
                disabled={true}
                className="w-full lg:w-auto self-start mt-auto !bg-[#FF6501] !text-black font-bold text-lg px-8 py-4 opacity-70 cursor-not-allowed"
              />
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-white max-w-4xl mx-auto">
            <div className="text-center card-hover-lift">
              <div className="text-[#FF6501] font-sora font-bold text-3xl mb-2">Hyderabad</div>
              <div className="metric-label text-sm">Location</div>
            </div>
            <div className="text-center card-hover-lift">
              <div className="text-[#FF6501] font-sora font-bold text-3xl mb-2">2026</div>
              <div className="metric-label text-sm">Year</div>
            </div>
            <div className="text-center card-hover-lift">
              <div className="text-[#FF6501] font-sora font-bold text-3xl mb-2">MARCH</div>

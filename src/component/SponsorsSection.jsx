  ...
  return (
    <div id="why-sponsor" className="max-w-6xl mx-auto">
      ...
      <FadeIn direction="up" duration={800}>
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tighter uppercase relative z-10">
            Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E68A00] to-[#E68A00]">Sponsor</span> ?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="relative group overflow-hidden rounded-3xl border border-white/10 bg-[#E68A00]/10 p-8 transition-all hover:border-[#E68A00]/30 hover:bg-[#E68A00]/15">
            <div className="relative z-10">
              <h3 className="text-[#E68A00] font-sora font-semibold text-lg sm:text-xl mb-4 tracking-tight">Unmatched Exposure</h3>
          ...
          <div className="relative group overflow-hidden rounded-3xl border border-white/10 bg-[#E68A00]/10 p-8 transition-all hover:border-[#E68A00]/30 hover:bg-[#E68A00]/15">
            <div className="relative z-10">
              <h3 className="text-[#E68A00] font-sora font-semibold text-lg sm:text-xl mb-4 tracking-tight">High‑Intent Audience</h3>
          ...
          <div className="relative group overflow-hidden rounded-3xl border border-white/10 bg-[#E68A00]/10 p-8 transition-all hover:border-[#E68A00]/30 hover:bg-[#E68A00]/15">
            <div className="relative z-10">
              <h3 className="text-[#E68A00] font-sora font-semibold text-lg sm:text-xl mb-4 tracking-tight">Measurable Results</h3>
      ...
      <FadeIn direction="up" delay={400} duration={800}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div ref={onSiteRef} className="relative group overflow-hidden rounded-3xl border border-white/10 bg-[#E68A00]/10 p-8 text-center transition-all hover:border-[#E68A00]/30 hover:bg-[#E68A00]/15">
            <div className="relative z-10">
              <div className="text-[#E68A00] font-sora text-2xl sm:text-3xl font-bold leading-none tracking-tight">{onSiteCount}</div>
              <div className="metric-label mt-2">On‑site Attendees</div>
            </div>
          </div>
          <div ref={speakersRef} className="relative group overflow-hidden rounded-3xl border border-white/10 bg-[#E68A00]/10 p-8 text-center transition-all hover:border-[#E68A00]/30 hover:bg-[#E68A00]/15">
            <div className="relative z-10">
              <div className="text-[#E68A00] font-sora text-2xl sm:text-3xl font-bold leading-none tracking-tight">{speakersCount}</div>
              <div className="metric-label mt-2">Global Speakers & Leaders</div>
            </div>
          </div>
          <div ref={partnersRef} className="relative group overflow-hidden rounded-3xl border border-white/10 bg-[#E68A00]/10 p-8 text-center transition-all hover:border-[#E68A00]/30 hover:bg-[#E68A00]/15">
            <div className="relative z-10">
              <div className="text-[#E68A00] font-sora text-2xl sm:text-3xl font-bold leading-none tracking-tight">{partnersCount}</div>
      ...
      <FadeIn direction="up" delay={600} duration={800}>
        <div className="relative group overflow-hidden rounded-3xl border border-white/10 bg-[#E68A00]/10 p-8 mb-10 transition-all hover:border-[#E68A00]/30 hover:bg-[#E68A00]/15">
          <div className="relative z-10">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/2 h-1/2 bg-[#E68A00] rounded-full mix-blend-screen filter blur-[100px] opacity-[0.05] group-hover:opacity-10 transition-opacity"></div>
        </div>
      </FadeIn>
      ...
      <div id="sponsors-cta" className="text-center scroll-mt-24">
        <a href="/apply/sponsor">
          <div className="inline-block">
            <Button label="Become a Sponsor" variant="primary" withStarBorder={true} starSpeed="5s" className="px-8 py-3 text-base !bg-[#E68A00] text-black" />
          </div>
        </a>
      </div>
    </div>

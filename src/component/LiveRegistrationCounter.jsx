  ...
  return (
    <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="relative group">
          {/* Card content */}
          <div className="relative bg-black rounded-lg p-8 border-2 border-[#FFBF00] shadow-[0_0_20px_rgba(255,191,0,0.3)] hover:shadow-[0_0_30px_rgba(255,191,0,0.5)] transition-shadow duration-300">

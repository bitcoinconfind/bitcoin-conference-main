    ...
    <div className="max-w-6xl mx-auto relative z-10 p-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-stretch">
        ...
        <div className="relative flex-grow lg:w-2/3 group">
          <div className="absolute inset-0 bg-[#E68A00] blur-[60px] opacity-10 rounded-full"></div>

          <div className="relative h-full bg-black/60 backdrop-blur-xl border border-[#E68A00]/30 p-8 md:p-12 overflow-hidden
                          lg:rounded-l-[3rem] lg:rounded-tr-[1rem] lg:rounded-br-[5rem] rounded-3xl
                          shadow-[0_0_40px_rgba(230,138,0,0.1)] transition-all duration-500">
            ...
            <div className="flex flex-col justify-between h-full relative z-10">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className={`p-3 rounded-xl bg-[#E68A00]/10 text-[#E68A00] ${showPulse ? 'animate-pulse' : ''}`}>
              ...
              <div className="mt-8">
                <div className={`text-6xl sm:text-7xl lg:text-8xl font-black text-[#E68A00] tracking-[0.05em] transition-all duration-300 ${showPulse ? 'scale-105' : 'scale-100'}`}>
              ...
              <div className="mt-8 pt-6 border-t border-[#E68A00]/30 flex items-center justify-between text-sm text-gray-400">
                <p>Join the revolution.</p>
                <span className="text-[#E68A00]">Bitcoin Forum India 2026</span>
              </div>
            </div>
          </div>
        </div>
...
const StatsPill = React.forwardRef(({ value, label, delay }, ref) => (
  <div ref={ref} className="group relative bg-black/50 hover:bg-black/70 border border-[#E68A00]/30 hover:border-[#E68A00]/50 p-5 rounded-2xl transition-all duration-300 hover:translate-x-2 shadow-lg backdrop-blur-sm">
    <div className="flex items-center justify-between">
      <div>
        <div className="text-2xl font-bold text-[#E68A00] group-hover:text-[#E68A00] transition-colors">{value}</div>
        <div className="text-xs text-gray-400 uppercase tracking-wider">{label}</div>
      </div>
      <div className="h-8 w-1 bg-[#E68A00] rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></div>
    </div>
  </div>
));

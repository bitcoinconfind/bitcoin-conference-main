      ...
      <div className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 w-[95%] md:w-[90%] lg:w-[85%]">
        ...
        <header
          className={`transition-all duration-500 ease-out border border-[#ff6501]/50
            ${isScrolled
              ? 'py-3 md:py-4 bg-[#0A0A0A]/80 shadow-[0_4px_30px_rgba(255,101,1,0.1)] backdrop-blur-2xl'
...
const NavLink = ({ children, to, href, onClick }) => {
  const baseClasses = "relative px-4 py-3 text-lg font-medium text-white/90 hover:text-[#ff6501] transition-colors duration-300";

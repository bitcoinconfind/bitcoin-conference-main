      ...
      <FadeIn direction="up" duration={800}>
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tighter uppercase relative z-10">
            Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff6501] to-[#ff6501]">Attend</span> ?
          </h2>
      ...
      <div className="space-y-12">
        <FadeIn direction="up" delay={200} duration={800}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#ff6501]/10 p-8 transition-all hover:border-[#ff6501]/30 hover:bg-[#ff6501]/15">
              <div className="h-full flex flex-col justify-between relative z-10">
                <div>
                  <h3 className="text-[#ff6501] font-sora font-semibold text-2xl lg:text-3xl mb-4 tracking-tight">Satoshi Lounge</h3>
                ...
                <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-[#ff6501] rounded-full mix-blend-screen filter blur-[100px] opacity-[0.15] group-hover:opacity-25 transition-opacity"></div>
              </div>
            </div>

            {/* 2. Bitcoin Bazaar (Tall/Standard) */}
            <div className="lg:col-span-1 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#ff6501]/10 p-8 transition-all hover:border-[#ff6501]/30 hover:bg-[#ff6501]/15">
              <div className="h-full flex flex-col justify-between relative z-10">
                <div>
                  <h3 className="text-[#ff6501] font-sora font-semibold text-xl lg:text-2xl mb-4 tracking-tight">Bitcoin Bazaar</h3>
            ...
            <div className="lg:col-span-1 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#ff6501]/10 p-8 transition-all hover:border-[#ff6501]/30 hover:bg-[#ff6501]/15">
              <div className="h-full flex flex-col justify-between relative z-10">
                <div>
                  <h3 className="text-[#ff6501] font-sora font-semibold text-xl lg:text-2xl mb-4 tracking-tight">Art District</h3>
                  <p className="metric-label text-base sm:text-lg">
            ...
            <div className="lg:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#ff6501]/10 p-8 transition-all hover:border-[#ff6501]/30 hover:bg-[#ff6501]/15">
              <div className="h-full flex flex-col justify-between relative z-10">
                <div>
                  <h3 className="text-[#ff6501] font-sora font-semibold text-2xl lg:text-3xl mb-4 tracking-tight">Network Square</h3>
                  <p className="metric-label text-base sm:text-lg max-w-2xl">
                ...
                <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-blue-500 rounded-full mix-blend-screen filter blur-[100px] opacity-[0.1] group-hover:opacity-20 transition-opacity"></div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#ff6501]/10 p-8 transition-all hover:border-[#ff6501]/30 hover:bg-[#ff6501]/15">
              <div className="h-full flex flex-col justify-between relative z-10">
                <div>
                  <h3 className="text-[#ff6501] font-sora font-semibold text-2xl lg:text-3xl mb-4 tracking-tight">Main Stage</h3>
                  <p className="metric-label text-base sm:text-lg max-w-2xl">
                ...
                <div className="absolute -top-20 -right-20 w-64 h-64 bg-purple-500 rounded-full mix-blend-screen filter blur-[100px] opacity-[0.1] group-hover:opacity-20 transition-opacity"></div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#ff6501]/10 p-8 transition-all hover:border-[#ff6501]/30 hover:bg-[#ff6501]/15">
              <div className="h-full flex flex-col justify-between relative z-10">
                <div>
                  <h3 className="text-[#ff6501] font-sora font-semibold text-xl lg:text-2xl mb-4 tracking-tight">Merch</h3>
                  <p className="metric-label text-base sm:text-lg">

          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#FF6501]/10 p-8 transition-all hover:border-[#FF6501]/30 hover:bg-[#FF6501]/15">
              <div className="h-full flex flex-col justify-between relative z-10">
                ...
                <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-[#FF6501] rounded-full mix-blend-screen filter blur-[100px] opacity-[0.1] group-hover:opacity-20 transition-opacity"></div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#FF6501]/10 p-8 transition-all hover:border-[#FF6501]/30 hover:bg-[#FF6501]/15">
              <div className="h-full flex flex-col justify-between relative z-10">
                ...
                <div className="absolute -top-20 -right-20 w-64 h-64 bg-[#FF6501] rounded-full mix-blend-screen filter blur-[100px] opacity-[0.1] group-hover:opacity-20 transition-opacity"></div>
              </div>
            </div>

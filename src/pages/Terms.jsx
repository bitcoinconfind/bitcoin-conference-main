    ...
    <div className="min-h-screen bg-[#FFFCFA] text-black py-20 px-4 sm:px-8 lg:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#FF8000] mb-2">Terms & Conditions</h1>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#FF8000] mb-4">6. Contact Information</h2>
            <p className="text-black leading-relaxed">
              If you have any questions about these Terms & Conditions, please contact us at contact@bitcoinforumindia.com
            </p>
          </section>
        </div>
      </div>

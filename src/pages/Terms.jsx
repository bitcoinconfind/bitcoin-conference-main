    ...
    <div className="min-h-screen bg-black text-white py-20 px-4 sm:px-8 lg:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <Link
            to="/"
            className="inline-flex items-center text-[#E68A00] hover:text-[#E68A00] transition-colors"
          >
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#E68A00] mb-2">Terms & Conditions</h1>
        ...
        <div className="prose prose-invert max-w-none">
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#E68A00] mb-4">1. Acceptance of Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#E68A00] mb-4">2. Event Information</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#E68A00] mb-4">3. Registration and Tickets</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#E68A00] mb-4">4. Limitation of Liability</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#E68A00] mb-4">5. Privacy</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#E68A00] mb-4">6. Contact Information</h2>
            <p className="text-gray-300 leading-relaxed">

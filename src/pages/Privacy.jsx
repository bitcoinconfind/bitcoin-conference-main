    ...
    <div className="min-h-screen bg-black text-white py-20 px-4 sm:px-8 lg:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#FF6501] mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-invert max-w-none">
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#FF6501] mb-4">1. Information We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#FF6501] mb-4">2. How We Use Your Information</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#FF6501] mb-4">3. Information Sharing</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#FF6501] mb-4">4. Data Security</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#FF6501] mb-4">5. Cookies</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-[#FF6501] mb-4">6. Contact Us</h2>
            <p className="text-gray-300 leading-relaxed">

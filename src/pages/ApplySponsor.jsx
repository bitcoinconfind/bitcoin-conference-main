  ...
  return (
    <section className="min-h-screen w-full px-4 sm:px-8 lg:px-20 pt-36 pb-20 bg-[#000000] relative overflow-hidden">
      <div className="max-w-4xl mx-auto relative z-10">
        {/* Back Button */}
        <div className="mb-8">
          <Link to="/" className="text-[#FF8000] hover:text-[#CC7A00] transition-colors flex items-center gap-2 mb-8">
        ...
        <div className="bg-[#000000] border-2 border-[#585858] rounded-2xl p-6 sm:p-8 hover:border-[#FF8000] transition-all duration-500">
          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Company Information */}
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-[#FF8000] mb-4">Company Information</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8000] focus:border-transparent ${errors.companyName ? 'border-red-500' : 'border-[#585858]'
                      }`}
            ...
            {/* Contact Information */}
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-[#FF8000] mb-4">Contact Information</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8000] focus:border-transparent ${errors.contactName ? 'border-red-500' : 'border-[#585858]'
                      }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8000] focus:border-transparent ${errors.contactEmail ? 'border-red-500' : 'border-[#585858]'
                      }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8000] focus:border-transparent ${errors.contactPhone ? 'border-red-500' : 'border-[#585858]'
                      }`}
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-[#FF8000] mb-4">Additional Information</h2>
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8000] focus:border-transparent resize-vertical ${errors.message ? 'border-red-500' : 'border-[#585858]'
                    }`}

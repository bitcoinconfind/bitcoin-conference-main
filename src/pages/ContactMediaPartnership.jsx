    ...
    <section className="min-h-[70vh] w-full flex items-start justify-center px-4 sm:px-8 lg:px-20 pt-36 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-2xl w-full bg-[#FFFCFA] border-2 border-[#585858] rounded-2xl p-6 sm:p-8 text-black hover:border-[#FF8000] transition-all duration-500 relative z-10">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            <input
              className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white ${errors.name ? 'border-red-500' : 'border-[#585858]'}`}
          ...
          <div>
            <input
              className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white ${errors.email ? 'border-red-500' : 'border-[#585858]'}`}
              placeholder="Email *"
              name="email"
              type="email"
          ...
          <div>
            <input
              className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white ${errors.organization ? 'border-red-500' : 'border-[#585858]'}`}
          ...
          <div>
            <input
              className="w-full px-4 py-3 bg-[#2a2a2a] border border-[#585858] rounded-lg text-white"
              placeholder="Website"
              name="website"
          ...
          <div>
            <input
              className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white ${errors.partnershipType ? 'border-red-500' : 'border-[#585858]'}`}
          ...
          <div>
            <textarea
              className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white ${errors.message ? 'border-red-500' : 'border-[#585858]'}`}
              placeholder="Message *"
              rows={6}
              name="message"

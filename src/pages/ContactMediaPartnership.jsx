    ...
    <section className="min-h-[70vh] w-full flex items-center justify-center px-4 sm:px-8 lg:px-20 py-20">
      <div className="max-w-2xl w-full bg-[#1F1F1F] border border-[#2a2a2a] rounded-2xl p-6 sm:p-8 text-white">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <input className="w-full px-4 py-3 bg-[#2a2a2a] border border-[#585858] rounded-lg" placeholder="Organization" name="organization" value={formData.organization} onChange={onChange} />
          <input className="w-full px-4 py-3 bg-[#2a2a2a] border border-[#585858] rounded-lg" placeholder="Website" name="website" value={formData.website} onChange={onChange} />
          <input className="w-full px-4 py-3 bg-[#2a2a2a] border border-[#585858] rounded-lg" placeholder="Partnership Type (Media, Community, Brand, etc.)" name="partnershipType" value={formData.partnershipType} onChange={onChange} />

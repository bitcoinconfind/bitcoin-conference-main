...
const Footer = () => {
  return (
    <footer className="w-full border-t border-[#FF8000]/30 bg-[#050505]/90 backdrop-blur-sm pt-8 pb-8">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-row-reverse md:flex-row flex-wrap justify-between items-end md:items-center gap-4 md:gap-8 mb-6">
          ...
          <div className="flex flex-col items-end md:items-start self-end md:self-auto gap-1">
            <Link to="/contact" className="text-[#FF8000] text-xs font-medium hover:opacity-80 uppercase tracking-widest">Contact Us</Link>
            <Link to="/privacy" className="text-[#FF8000] text-xs font-medium hover:opacity-80 uppercase tracking-widest">Privacy Policy</Link>
            <Link to="/terms" className="text-[#FF8000] text-xs font-medium hover:opacity-80 uppercase tracking-widest">Terms & Conditions</Link>
          </div>
        ...
        {/* Disclaimer Section */}
        <div className="flex flex-col items-center text-center border-t border-[#FF8000]/10 pt-8">
          <h4 className="text-[#FF8000] text-xs font-bold uppercase tracking-[0.2em] mb-4">Disclaimer</h4>

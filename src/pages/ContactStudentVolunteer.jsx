...
const ContactStudentVolunteer = () => {
  ...
  return (
    <section className="min-h-[70vh] w-full flex items-start justify-center px-4 sm:px-8 lg:px-20 pt-36 pb-20 relative overflow-hidden">
      ...
      <div className="bg-black border-2 border-[#585858] rounded-2xl p-6 sm:p-8 hover:border-[#E68A00] transition-all duration-500 relative z-10">
        <div className="mb-8 p-4 relative z-10">
          <button className="w-full bg-[#E68A00] text-black font-semibold px-6 py-3 rounded-lg hover:bg-[#CC7A00] transition-colors mb-6 group">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            <label className="block mb-1 text-sm text-gray-300">Full Name <span className="text-[#E68A00]" aria-hidden>*</span></label>
          ...
          <div>
            <label className="block mb-1 text-sm text-gray-300">Email <span className="text-[#E68A00]" aria-hidden>*</span></label>
          ...
          <div>
            <label className="block mb-1 text-sm text-gray-300">Phone <span className="text-[#E68A00]" aria-hidden>*</span></label>
          ...
          <div>
            <label className="block mb-1 text-sm text-gray-300">University / Organization <span className="text-[#E68A00]" aria-hidden>*</span></label>
          ...
          <div>
            <label className="block mb-1 text-sm text-gray-300">City <span className="text-[#E68A00]" aria-hidden>*</span></label>
          ...
          <div>
            <label className="block mb-1 text-sm text-gray-300">Interested Role <span className="text-[#E68A00]" aria-hidden>*</span></label>
          ...
          <div>
            <label className="block mb-1 text-sm text-gray-300">Availability (dates/hours) <span className="text-[#E68A00]" aria-hidden>*</span></label>
          ...
          <div>
            <label className="block mb-1 text-sm text-gray-300">Message <span className="text-[#E68A00]" aria-hidden>*</span></label>
            <textarea required aria-required="true" className="w-full px-4 py-3 bg-[#2a2a2a] border border-[#585858] rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E68A00] focus:border-transparent" rows={6} name="message" value={formData.message} onChange={onChange} />
          </div>
          <Button type="submit" label={loading ? 'Submitting...' : 'Submit'} className="w-full py-3 text-lg !bg-none !bg-transparent !border-2 !border-[#E68A00] !text-[#E68A00] shadow-[0_0_10px_rgba(230,138,0,0.3)] hover:!bg-[#E68A00]/10 hover:!shadow-[0_0_20px_rgba(230,138,0,0.6)] transition-all duration-300" disabled={loading} />

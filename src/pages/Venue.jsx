  ...
  return (
    <div className="relative w-full z-0">
      ...
      <div className="w-full flex justify-center mt-8 sm:mt-10 mb-8 sm:mb-10 px-5">
        <div className="w-[95%] sm:w-[90%] md:w-[85%] lg:w-[78%] h-[1px] border-t border-[0.5px] [border-image-source:linear-gradient(90deg,#010101_20.49%,#FBF5EE_47.96%,#010101_84.28%)] [border-image-slice:1]"></div>
      </div>

    ...
    return (
      <section className="min-h-[70vh] w-full flex items-center justify-center px-4 sm:px-8 lg:px-20 py-20">
        <div className="max-w-md w-full bg-[#1F1F1F] border border-[#2a2a2a] rounded-2xl p-6 sm:p-8 text-white text-center">
          ...
          <a href="/admin/login" className="text-[#E68A00] hover:underline">Go to Admin Login</a>
        </div>
      </section>
    );
  }
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              <button
                ...
                className={`px-3 py-2 rounded-lg border text-sm ${activeTab === 'contact'
                    ? 'border-[#E68A00] bg-[#E68A00]/10 text-[#E68A00]'
            ...
            <div className="space-y-4">
              {filtered.map((r) => (
                <div key={r.id} className="bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg p-3 sm:p-4">
                  ...
                  <div className="mb-3">
                    <h4 className="text-[#E68A00] font-medium mb-1 text-sm sm:text-base">Subject:</h4>
                    <p className="text-white text-sm sm:text-base break-words">{r.subject}</p>
                  </div>

                  <div className="mb-3">
                    <h4 className="text-[#E68A00] font-medium mb-1 text-sm sm:text-base">Message:</h4>
            ...
            <div className="space-y-4">
              {filtered.map((r) => (
                <div key={r.id} className="bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg p-3 sm:p-4">
                  ...
                  <div className="mb-3">
                    <h4 className="text-[#E68A00] font-medium mb-1 text-sm sm:text-base">Topic Title:</h4>
                    <p className="text-white font-medium text-sm sm:text-base break-words">{r.topic_title}</p>
                  </div>

                  <div className="mb-3">
                    <h4 className="text-[#E68A00] font-medium mb-1 text-sm sm:text-base">Topic Abstract:</h4>
                    <p className="text-white whitespace-pre-wrap text-sm sm:text-base break-words">{r.topic_abstract}</p>
                  </div>

                  <div className="mb-3">
                    <h4 className="text-[#E68A00] font-medium mb-1 text-sm sm:text-base">Bio:</h4>
                    <p className="text-white whitespace-pre-wrap text-sm sm:text-base break-words">{r.bio}</p>
                  </div>

                  <div className="mb-3">
                    <h4 className="text-[#E68A00] font-medium mb-1 text-sm sm:text-base">Experience:</h4>
                    <p className="text-white whitespace-pre-wrap text-sm sm:text-base break-words">{r.experience}</p>
                  </div>

                  <div className="mb-3">
                    <h4 className="text-[#E68A00] font-medium mb-1 text-sm sm:text-base">Target Audience:</h4>
                    <p className="text-white whitespace-pre-wrap text-sm sm:text-base break-words">{r.audience}</p>
                  </div>

                  {r.previous_speaking && (
                    <div className="mb-3">
                      <h4 className="text-[#E68A00] font-medium mb-1 text-sm sm:text-base">Previous Speaking:</h4>
              ...
              {filtered.map((r) => (
                <div key={r.id} className="bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                    {r.role_interest && (
                      <div>
                        <h4 className="text-[#E68A00] font-medium mb-1">Role Interest:</h4>
                        <p className="text-white">{r.role_interest}</p>
                      </div>
                    )}
                    {r.availability && (
                      <div>
                        <h4 className="text-[#E68A00] font-medium mb-1">Availability:</h4>
                        <p className="text-white">{r.availability}</p>
                      </div>
                    )}
                  </div>
                  <div className="mb-3">
                    <h4 className="text-[#E68A00] font-medium mb-1">Message:</h4>
              ...
              {filtered.map((r) => (
                <div key={r.id} className="bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                    {r.partnership_type && (
                      <div>
                        <h4 className="text-[#E68A00] font-medium mb-1">Type:</h4>
                        <p className="text-white">{r.partnership_type}</p>
                      </div>
                    )}
                    {r.phone && (
                      <div>
                        <h4 className="text-[#E68A00] font-medium mb-1">Phone:</h4>

        ...
        <div className="text-center mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            ...
            <div className="bg-[#242424] border border-[#3a3a3a] rounded-xl p-6 flex flex-col min-h-[260px]">
              ...
              <button onClick={() => window.location.href='/apply/speaker'} className="w-full bg-[#FFBF00] text-black font-semibold py-2 rounded-md hover:bg-[#CB7608] mt-auto">Apply to Speak</button>
            </div>
            <div className="bg-[#242424] border border-[#3a3a3a] rounded-xl p-6 flex flex-col min-h-[260px]">
              ...
              <button onClick={() => window.location.href='/apply/sponsor'} className="w-full bg-[#FFBF00] text-black font-semibold py-2 rounded-md hover:bg-[#CB7608] mt-auto">Become a Sponsor</button>
            </div>
          </div>
        </div>
      </div>

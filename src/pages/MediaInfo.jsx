      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 relative">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tighter uppercase relative z-10">
            Media & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E68A00] to-[#E68A00]">Partnerships</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="bg-black border-2 border-[#585858] rounded-xl p-6 hover:border-[#E68A00] transition-all duration-500">
            <div className="text-xl md:text-2xl font-bold text-[#E68A00] mb-2">Priority Access</div>
            <p className="metric-label">Press lounge, scheduled interview slots, and stage-side access for approved crews.</p>
          </div>
          <div className="bg-black border-2 border-[#585858] rounded-xl p-6 hover:border-[#E68A00] transition-all duration-500">
            <div className="text-xl md:text-2xl font-bold text-[#E68A00] mb-2">Co‑Branded Moments</div>
            <p className="metric-label">Partner segments, on‑ground activations, and content integrations amplified on our channels.</p>
          </div>
          <div className="bg-black border-2 border-[#585858] rounded-xl p-6 hover:border-[#E68A00] transition-all duration-500">
            <div className="text-xl md:text-2xl font-bold text-[#E68A00] mb-2">Content Support</div>
        ...
        <div className="text-center">
          <a href="/contact/media-partnership">
            <button className="bg-transparent border-2 border-[#E68A00] text-[#E68A00] font-semibold px-6 py-3 rounded-lg shadow-[0_0_10px_rgba(230,138,0,0.3)] hover:bg-[#E68A00]/10 hover:shadow-[0_0_20px_rgba(230,138,0,0.6)] transition-all duration-300">Apply for Media & Partnerships</button>
          </a>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="metric-label">
            ...
            <a href="mailto:partnerships@btcindia.media" className="text-[#E68A00] hover:underline">partnerships@btcindia.media</a>.
          </p>
        </div>
      </div>
    </section>

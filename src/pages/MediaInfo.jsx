      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center">
          <a href="/contact/media-partnership">
            <button className="bg-transparent border-2 border-[#FF8000] text-[#FF8000] font-semibold px-6 py-3 rounded-lg shadow-[0_0_10px_rgba(255,128,0,0.3)] hover:bg-[#FF8000]/10 hover:shadow-[0_0_20px_rgba(255,128,0,0.6)] transition-all duration-300">Apply for Media & Partnerships</button>
          </a>
        </div>

      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="bg-black border-2 border-[#585858] rounded-2xl p-6 sm:p-8 hover:border-[#FF8000] transition-all duration-500">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* Query Details */}
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-[#FF8000] mb-4">Query Details</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 bg-[#2a2a2a] border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8000] focus:border-transparent ${errors.subject ? 'border-red-500' : 'border-[#585858]'
                      }`}

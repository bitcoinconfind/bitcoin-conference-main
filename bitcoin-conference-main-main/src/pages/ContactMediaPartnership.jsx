...
const ContactMediaPartnership = () => {
  ...
  return (
    <section className="min-h-[70vh] w-full flex items-center justify-center px-4 sm:px-8 lg:px-20 py-20">
      <div className="max-w-2xl w-full bg-black border-2 border-[#585858] rounded-2xl p-6 sm:p-8 text-white hover:border-[#f7931a] transition-all duration-500 ticket-card-gradient hover:shadow-[0_20px_50px_rgba(247,147,26,0.3)]">

        ...
        <div className="text-center mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="bg-black border-2 border-[#585858] rounded-xl p-6 flex flex-col min-h-[260px] hover:border-[#f7931a] transition-all duration-500">
              ...
              <Button onClick={() => window.location.href='/contact/general'} label="Fill the form" variant="secondary" className="w-full py-2 font-semibold !border-[#f7931a] !border-2 !bg-transparent hover:!bg-[#f7931a]/10 transition-all duration-300 !text-[#f7931a] mt-auto" />
            </div>
            <div className="bg-black border-2 border-[#585858] rounded-xl p-6 flex flex-col min-h-[260px] hover:border-[#f7931a] transition-all duration-500">
              ...
              <Button onClick={() => window.location.href='/apply/speaker'} label="Apply to Speak" variant="secondary" className="w-full py-2 font-semibold !border-[#f7931a] !border-2 !bg-transparent hover:!bg-[#f7931a]/10 transition-all duration-300 !text-[#f7931a] mt-auto" />
            </div>
            <div className="bg-black border-2 border-[#585858] rounded-xl p-6 flex flex-col min-h-[260px] hover:border-[#f7931a] transition-all duration-500">
              ...
              <Button onClick={() => window.location.href='/apply/sponsor'} label="Become a Sponsor" variant="secondary" className="w-full py-2 font-semibold !border-[#f7931a] !border-2 !bg-transparent hover:!bg-[#f7931a]/10 transition-all duration-300 !text-[#f7931a] mt-auto" />
            </div>
          </div>
        </div>
      </div>

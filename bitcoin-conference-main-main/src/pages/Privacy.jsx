      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-familjen text-[#f7931a] mb-4">1. Information We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-familjen text-[#f7931a] mb-4">2. How We Use Your Information</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-familjen text-[#f7931a] mb-4">3. Information Sharing</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-familjen text-[#f7931a] mb-4">4. Data Security</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-familjen text-[#f7931a] mb-4">5. Cookies</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-familjen text-[#f7931a] mb-4">6. Contact Us</h2>
            <p className="text-gray-300 leading-relaxed">

...
const Button = ({
  ...
  const variants = {
    primary:
      "bg-[#f7931a] font-familjen border border-2 border-[#f7931a] text-black cursor-pointer font-semibold",
    secondary:
      "bg-[#FFFFFF] font-familjen border border-3 border-[#f7931a] text-black cursor-pointer",
    general:
      "bg-[#1F1F1F] font-familjen text-black cursor-pointer rounded-sm font-semibold h-15",
    comman:
      "bg-[#F78D1E] font-familjen border border-2 border-[#f7931a] text-white cursor-pointer rounded-sm font-semibold",
